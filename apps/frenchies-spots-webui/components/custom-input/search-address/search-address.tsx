...
import { AutocompleteInput, type AutocompleteInputProps} from "@frenchies-spots/materials";
...
export interface SearchAddressProps<T> extends Omit<AutocompleteInputProps<T>, "onChangeText" | "value" | "data"> {
  value?: TLocation;
